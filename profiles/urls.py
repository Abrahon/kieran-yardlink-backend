...
from .views import AdminProfileView,ChangePasswordView,WorkerProfileView,ProLandscaperWorkersView,ClientProfileView,ChangePasswordWorkerView,ChangePasswordLandscaperView,ChangePasswordClientView,ProLandScaperProfileView
...
urlpatterns = [
    ...
    path("landscapers/", ProLandScaperProfileView.as_view(), name="pro-landscaper"),
